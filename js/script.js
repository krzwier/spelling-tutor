...
const joshReadingList = [
   "Please do not climb out the window.",
   "How old are you?",
   "He will show me the route to school.",
   "The rain cloud hovered over the town.",
   "The creepy clown laughed and laughed.",
   "Paisly will sometimes growl if she thinks she sees a threat.",
   "Here we go round the mulberry bush.",
   "Down down baby, down by the roller coaster.",
   "The plane touched down on the ground.",
   "Poop is usually brown.",
   "The owl was hunting in the night.",
   "I found my lost shoe!",
   "Please do not shout at the top of your lungs!",
   "Did you finish the rough draft of your paragraph?",
   "Turn that frown upside-down!",
   "She wore a beautiful ball gown to the dance.",
   "Please do not chew with your mouth open.",
   "Please plow the field tomorrow.",
   "The sun shines strongest from the south.",
   "I got to wear a glow necklace on Halloween.",
   "Our town is a friendly place.",
   "Can you count to 100?",
   "The train passed through the tunnel.",
   "The crow sat on top of the tree and watched everything."
];
