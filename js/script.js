...
const joshReadingList = [
   "We often watch TV on Saturday mornings.",
   "I found a small pebble on my doorstep.",
   "He thought that there was an elephant in the bathroom.",
   "The walk to school takes about twenty minutes.",
   "I like lots of salt on my eggs.",
   "He helps his mom wash the dishes.",
   "Do you really believe that, though?",
   "She needs to calm down.",
   "They bought a new car last month.",
   "Harry Potter had a magic wand.",
   "They like to talk and talk for hours.",
   "Cats love to stalk birds and mice.",
   "He has been going bald in his old age.",
   "I found a wasp nest under the roof.",
   "My brother and I fought about the rules of the game.",
   "I like to swap trinkets with my friends.",
   "Some teachers use chalk when they teach.",
   "That bathroom stall was dirty.",
   "You ought to brush your teeth.",
   "She tried to swat at the fly.",
   "She brought a huge backpack to school today.",
   "My nose stopped running, but now I have a bad cough.",
   "Please cut the fruit in half so that we can share it.",
