...
const joshReadingList = [
   "You get one hour of screen time on school nights.",
   "If you exercise, you will become strong.",
   "When winter is over, spring will come.",
   "Sometimes your mother is strange.",
   "Do not spray ketchup all over the kitchen.",
   "We often have to tell Paisley to scram.",
   "Don't sprain your ankle!",
   "Attach the strap of the bag here.",
   "My teacher is very strict.",
   "If you experience stress, you should talk to someone about it.",
   "I heard a terrifying scream at midnight.",
   "What are you going to do with that scrap of fabric?",
   "The beans will soon sprout from the soil.",
   "He fell off his bike and got a scrape on his knee.",
   "Don't tie that string too tight.",
   "Did you see the rainbow stripe pattern on that shirt?",
   "The ball struck me in the back of the head.",
   "Please spread the peanut butter on my sandwich very thick!",
   "Paisley likes it when we scratch her back.",
   "The stream begins in the mountains and flows into the river below.",
   "Make sure to scrub the dirt from under your nails.",
   "Josh loves to do his morning stretch.",
   "Your strength will increase as you grow older and bigger.",
   "Make sure to draw a straight line across the page."
];
