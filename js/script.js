...
const joshReadingList = [
   ...
   "Rain showers cause plants to grow.",
   "Jesus carried the cross.",
   "James caught five fish.",
   "Paisley has four paws.",
   "Chickens like to make nests with straw.",
   "It's not your fault!",
   "It's best to avoid breaking the law.",
   "Paisley has one really long claw on her front paw.",
   "The tomato sauce in the spaghetti was delicious.",
   "Mrs. DeBondt taught me many things in math today.",
   "I love to draw dinosaurs with teeth in their guts.",
   "I love to laugh with my friends.",
   "We're in for a long haul on this road trip.",
   "Please pause the show so we can talk for a few minutes.",
   "Claire played a very loud song on her trumpet.",
   "The windows frost up in winter.",
   "The hawk dove down to eat a mouse.",
   "Babies crawl around on the floor.",
   "At dawn, the light in the east is beautiful.",
   "Our lawn is becoming more brown now that it is fall.",
   "Mommy works in a bank vault.",
   "She wore a shawl over her shoulders to keep warm.",
   "That is a beautiful, silky cloth!"
];
